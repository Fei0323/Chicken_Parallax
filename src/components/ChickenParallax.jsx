    ...
    return (
        <header>
            ...
            <div id="parallaxContainer">
                ...
                <h1 className="parallaxLayer" style={{ transform: `translateY(${offsetY * 1}px)` }}>ChickenParallax</h1>
                <img src={grass} alt="" className="parallaxLayer" />
                <img src={coop} alt="" className="parallaxLayer" />
                <img src={chicken} alt="" className="parallaxLayer" style={{ transform: `translateY(${offsetY * 2}px)` }} />
